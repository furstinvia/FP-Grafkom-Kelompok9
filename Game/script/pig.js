...
function Chicken() {
  ...
  const snout = new THREE.Mesh(new THREE.CylinderBufferGeometry(5 * zoom, 5 * zoom, 10 * zoom, 32), snoutMaterial);
  ...
  const tail = new THREE.Mesh(new THREE.TorusBufferGeometry(3 * zoom, 1 * zoom, 16, 100, Math.PI), tailMaterial);
